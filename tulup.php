...
echo color("red"," ||       |||  |||     ||  |||   |||     .||||| \n");
echo color("white"," ||       |||  |||,    ,||  ||   |||      |||| \n");
echo color("white"," ||||||||||||  |||||.    .|||  -$###26373| \n");
echo "⤵\n";
sleep(2);
echo "⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛\n";
echo "⬛FOLLOW INSTAGRAM Nailulhudaa⬛\n";
echo "⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛⬛\n";
sleep(1);
echo "⬜     DAFTAR  GOJEK  CS     ✅\n";
sleep(1);
echo "⬜⬛    GOJEK PASTI ADA JALAN   ✅ \n";
sleep(1);
echo "⬜⬛🔳  FOR  VCR GOJEK  ✅\n";
echo"⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜\n";
echo "⤵\n";
...
// function change(){
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"PAKEGOFOOD0609}');
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("green","🔓 Message: ".$message);
        echo "\n".color("nevy","KLAIM LAGI");
        echo "\n".color("yellow","W A I T . . .");
